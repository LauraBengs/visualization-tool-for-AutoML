...
% **************************************************
\newcommand{\thesisTitle}{How can a visualisation tool increase trust in AutoML systems and does it help users to better understand AutoML processes? - Development of a visualisation tool for an AutoML system}
\newcommand{\thesisName}{Laura Bengs}
...
\newcommand{\thesisFirstSupervisor}{Jonas Hanselle}
\newcommand{\thesisSecondSupervisor}{Marcel Wever}
